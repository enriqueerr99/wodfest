// API endpoint para crear sesión de checkout con Stripe
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${process.env.DOMAIN_URL || 'https://wodfest-salou.vercel.app'}/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.DOMAIN_URL || 'https://wodfest-salou.vercel.app'}/cancel`,
